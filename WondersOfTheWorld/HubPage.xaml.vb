...
Public NotInheritable Class HubPage
    ...
    Private Async Sub NavigationHelper_LoadState(sender As Object, e As Common.LoadStateEventArgs)
        ...
        Dim sampleDataGroup As Data.SampleDataGroup = Await Data.SampleDataSource.GetGroupAsync("Group-1")
        Me.DefaultViewModel("Section3Items") = sampleDataGroup

        Dim newDataGroup As Data.SampleDataGroup = Await Data.SampleDataSource.GetGroupAsync("Group-2")
        Me.DefaultViewModel("Section4Items") = newDataGroup
    End Sub
